...
# Flatten JSON data
runresults_data = flatten_json(json_data)
...
cur.execute("""
    CREATE TABLE IF NOT EXISTS runresults_data (
...
for key, value in runresults_data.items():
    cur.execute("INSERT INTO runresults_data (key, value) VALUES (%s, %s)", (key, json.dumps(value)))
